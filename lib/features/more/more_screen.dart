...
class MoreScreen extends StatelessWidget {
    ...
    return PageBody(
      children: [
        ...
        SitePanel(
          ...
          child: Column(
            children: [
              _tile(context, Icons.tune_rounded, s.settings, '/asetukset'),
            ],
          ),
        ),
        const AdSlot(),
  ...
  Widget _link(
    ...
    onTap: () => openUrl(context, SiteUrl.path(slug)),
  );
}
          ...
          SitePanel(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 18),
                FilledButton.icon(
                  onPressed: () => openUrl(context, SiteUrl.path(slug)),
